...
var USE_SYMBOL_AS_UID = __webpack_require__(135);
...
var global = __webpack_require__(2);
var DESCRIPTORS = __webpack_require__(5);
var TYPED_ARRAYS_CONSTRUCTORS_REQUIRES_WRAPPERS = __webpack_require__(120);
var ArrayBufferViewCore = __webpack_require__(8);
var ArrayBufferModule = __webpack_require__(87);
...
var defineProperty = __webpack_require__(9).f;
var uid = __webpack_require__(54);
var FREEZING = __webpack_require__(61);
...
var toPositiveInteger = __webpack_require__(363);
...
var $ = __webpack_require__(0);
var getBuiltIn = __webpack_require__(25);
var USE_NATIVE_URL = __webpack_require__(169);
var redefine = __webpack_require__(14);
var redefineAll = __webpack_require__(50);
var setToStringTag = __webpack_require__(30);
var createIteratorConstructor = __webpack_require__(109);
...
var foreach = __webpack_require__(511);
...
var requirePromise = __webpack_require__(127);

requirePromise();

var ES = __webpack_require__(512);
var bind = __webpack_require__(93);
...
var _v = __webpack_require__(421);

var _v2 = _interopRequireDefault(_v);

var _includes = __webpack_require__(424);

var _includes2 = _interopRequireDefault(_includes);

var _merge = __webpack_require__(448);

var _merge2 = _interopRequireDefault(_merge);

var _jsCookie = __webpack_require__(505);

var _jsCookie2 = _interopRequireDefault(_jsCookie);

var _nanoajax = __webpack_require__(506);

var _nanoajax2 = _interopRequireDefault(_nanoajax);

var _promisePrototype = __webpack_require__(507);

var _promisePrototype2 = _interopRequireDefault(_promisePrototype);

var _sso_app_routes = __webpack_require__(523);

var _sso_app_routes2 = _interopRequireDefault(_sso_app_routes);
...
var IdeoSSO = function () {
  function IdeoSSO() {
    _classCallCheck(this, IdeoSSO);
  }
  ...
  _createClass(IdeoSSO, [{
    ...
    value: function logout() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _nanoajax2.default.ajax({
          url: _this._routes.apiUserSessionDestroyUrl,
          method: 'DELETE',
          withCredentials: true,
          cors: true
        }, function (code, response) {
          if (_this._successfulAjaxStatus(code)) {
            if (redirect) {
    ...
    value: function getUserInfo() {
      ...
      return new Promise(function (resolve, reject) {
        _nanoajax2.default.ajax({
          url: _this2._routes.apiUserUrl,
          method: 'GET',
          responseType: 'json',
          withCredentials: true,
          cors: true
        }, function (code, response) {
          if (_this2._successfulAjaxStatus(code)) {
            resolve(response);
          } else {
            reject(response);
          }
    ...
    key: '_setCookie',
    value: function _setCookie(key, value) {
      var expiresInHours = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
      ...
      return _jsCookie2.default.set('IdeoSSO-' + key, value, opts);
    }
  }, {
    key: '_getCookie',
    value: function _getCookie(key) {
      return _jsCookie2.default.get('IdeoSSO-' + key);
    }
  }, {
    key: '_hoursFromNow',
    value: function _hoursFromNow(numHours) {
      var d = new Date();
      var milliseconds = numHours * 60 * 60 * 1000;
      return d.setTime(d.getTime() + milliseconds);
    }
  }, {
    key: '_successfulAjaxStatus',
    value: function _successfulAjaxStatus(code) {
      return (0, _includes2.default)([200, 301, 302], code);
    }
  }, {
    key: 'env',
    get: function get() {
...
var $ = __webpack_require__(0);
var fails = __webpack_require__(1);
var nativeGetOwnPropertyNames = __webpack_require__(137).f;
...
var $ = __webpack_require__(0);
var DESCRIPTORS = __webpack_require__(5);
var FORCED = __webpack_require__(71);
var toObject = __webpack_require__(10);
var aFunction = __webpack_require__(19);
var definePropertyModule = __webpack_require__(9);
...
var classof = __webpack_require__(24);
var isRegExp = __webpack_require__(77);
var getRegExpFlags = __webpack_require__(66);
var createNonEnumerableProperty = __webpack_require__(16);
var fails = __webpack_require__(1);
var wellKnownSymbol = __webpack_require__(6);
...
var $ = __webpack_require__(0);
var parseIntImplementation = __webpack_require__(153);
...
var $ = __webpack_require__(0);
var numberIsFinite = __webpack_require__(311);
...
var createNonEnumerableProperty = __webpack_require__(16);
var dateToPrimitive = __webpack_require__(346);
var wellKnownSymbol = __webpack_require__(6);
...
var codeAt = __webpack_require__(76).codeAt;
var toASCII = __webpack_require__(417);
var setToStringTag = __webpack_require__(30);
...
var bytesToUuid = __webpack_require__(423);
...
var baseIndexOf = __webpack_require__(425),
    isArrayLike = __webpack_require__(67),
    isString = __webpack_require__(431),
    toInteger = __webpack_require__(432),
    values = __webpack_require__(436);
...
var baseValues = __webpack_require__(437),
...
var baseMerge = __webpack_require__(449),
...
var Stack = __webpack_require__(450),
    assignMergeValue = __webpack_require__(181),
    baseFor = __webpack_require__(479),
    baseMergeDeep = __webpack_require__(481),
    isObject = __webpack_require__(40),
...
var mapCacheClear = __webpack_require__(467),
    mapCacheDelete = __webpack_require__(474),
...
var assignMergeValue = __webpack_require__(181),
    cloneBuffer = __webpack_require__(482),
    ...
    isObject = __webpack_require__(40),
    isPlainObject = __webpack_require__(490),
    isTypedArray = __webpack_require__(178),
    toPlainObject = __webpack_require__(491);
...
var cloneArrayBuffer = __webpack_require__(484);
...
var Uint8Array = __webpack_require__(485);
...
var copyObject = __webpack_require__(492),
    keysIn = __webpack_require__(184);
...
var identity = __webpack_require__(185),
    overRest = __webpack_require__(498),
...
var baseSetToString = __webpack_require__(501),
    shortOut = __webpack_require__(503);
...
var ES2015 = __webpack_require__(514);
...
var ES5 = __webpack_require__(519);

var hasRegExpMatcher = __webpack_require__(521);
...
var isPrimitive = __webpack_require__(188);
var isCallable = __webpack_require__(129);
var isDate = __webpack_require__(516);
...
var SSOAppRoutes = function () {
  function SSOAppRoutes() {
    _classCallCheck(this, SSOAppRoutes);
  }

  _createClass(SSOAppRoutes, [{
    key: 'init',
    value: function init() {
      var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
...
exports.default = new SSOAppRoutes();
module.exports = exports['default'];
